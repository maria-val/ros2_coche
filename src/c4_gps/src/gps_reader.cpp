...
class GpsReader : public rclcpp::Node   //heredo método y funciones de la clase rclcpp::Node
{
  public:
    GpsReader()
        : Node("gps_reader") //constructor que llama al constructor Node, es decir, el constructor crea un nodo en ROS2
    {
...
int main(int argc, char *argv[])
{
  ...
  rclcpp::spin(std::make_shared<GpsReader>());
  rclcpp::shutdown();
  return 0;
}
