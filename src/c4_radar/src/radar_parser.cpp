...
class RadarParser : public rclcpp::Node
{
  public:
    ...
    {
      std::string header_ = declare_parameter<std::string>("header", "t60");
      std::string topic_publisher_ = declare_parameter<std::string>("topic_publisher", "radar_parser/t60");
      
      if(strcmp(header_.c_str(), "t60") == 0)
      {
        parsed_t60_publisher_  = this->create_publisher<radar_msgs::msg::RadarMsg408>(topic_publisher_.c_str(), 1000);
        ...
        radarARS.m_radar_msg_pub = parsed_t60_publisher_;

        ars408_t60_subscriber_ = this->create_subscription<radar_msgs::msg::RadarRaw>("radar_reader/ars408", 1000, std::bind(&Radar_ARS408::parse_radar_msg_408, radarARS, std::placeholders::_1));
  ...
  private:
    rclcpp::Subscription<radar_msgs::msg::RadarRaw>::SharedPtr ars408_t60_subscriber_;
    ...
    rclcpp::Publisher<radar_msgs::msg::RadarMsg408>::SharedPtr parsed_t60_publisher_;
