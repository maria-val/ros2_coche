...
class RadarParser : public rclcpp::Node
{
  ...
  private:
    ...
    void parse_srr208_msg(const radar_msgs::msg::RadarRaw::SharedPtr msgIn)
    {
      ...
      auto parsed_srr208_publisher_ = this->create_publisher<radar_msgs::msg::RadarMsg208>("radar_parser/srr208", 1000);
    ...
    rclcpp::Publisher<radar_msgs::msg::RadarMsg208>::SharedPtr parsed_ssr208_publisher_;
};
